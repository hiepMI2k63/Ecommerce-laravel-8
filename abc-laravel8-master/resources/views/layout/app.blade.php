                            ...
                            <ul>
                                <li class="menu-item lang-menu menu-item-has-children parent">
                                    <a title="English" href="#"><span class="img label-before"><img
                                                src="{{ url('file') }}/images/lang-en.png"
                                    ...
                                    @auth
                                        @if (Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="" href="{{ route('admin_dashboard') }}">Dashboard</a>
                                                    </li>
                                                    <li class="menu-item"><a href="{{ route('admin_category') }}"><span
                                                                class="img label-before"></span>Category</a></li>
                                                    <li class="menu-item"><a href="{{ route('admin_product') }}"><span
                                                                class="img label-before"></span>Product</a></li>
                                                    {{-- <li class="menu-item" ><a  href="{{route('homeslider')}}"><span class="img label-before"></span>Homeslider</a></li> --}}
                                                    <li class="menu-item"><a href="{{ route('admin_coupons') }}"><span
                                                                class="img label-before"></span>Coupons</a></li>
                                                    <li class="menu-item"><a href="{{ route('admin_orders') }}"><span
                                                                class="img label-before"></span>Orders</a></li>
                                                    <li class="menu-item"><a href="{{ route('admin_contactUs') }}"><span
                                                                class="img label-before"></span>ContactUs</a></li>
                                                    <li class="menu-item"><a
                                                            href="{{ route('admin_category') }}"><span
                                                                class="img label-before"></span>Category</a></li>
                                                    <li class="menu-item"><a href="{{ route('admin_product') }}"><span
                                                                class="img label-before"></span>Product</a></li>
                                                    <li class="menu-item">
                                                        <a title="logout" href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('form-login').submit();">Logout</a>
                                                    </li>
                                        ...
                                        @else
                                            ...
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="My account" href="#">{{ Auth::user()->name }}<i
                                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item"><a href="{{ route('user_orders') }}"><span
                                                        class="img label-before"></span>My Order</a></li>

                                                    <li class="menu-item"><a href="{{ route('user_changePass') }}"><span
                                                            class="img label-before"></span>Change Password</a></li>
                        ...
                        <div class="header-nav-section">
                            <div class="container">
                                <ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info">
                                    ...
                                    <li class="menu-item"><a href="#" class="link-term">Top new
                                            items</a><span class="nav-label hot-label">hot</span></li>
                                    <li class="menu-item"><a href="#" class="link-term">Top
                        ...
                        <div class="primary-nav-section">
                            <div class="container">
                                <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="{{ route('contactus') }}" class="link-term mercado-item-title">Contact
                                            Us</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="wrap-contact-detail">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p class="contact-txt">45 Grand Central Terminal New
                                                        York,NY 1017 United State USA</p>
                                                </li>
                                                <li>
                                                    <i class="fa fa-phone" aria-hidden="true"></i>
                                                    <p class="contact-txt">(+123) 456 789 - (+123) 666 888
                                                    </p>
                                                </li>
                                                <li>
                ...
                <div class="coppy-right-box">
                    <div class="container">
                        <div class="coppy-right-item item-left">
                            <p class="coppy-right-text">Copyright © 2020 Surfside Media. All rights reserved
                            </p>
                        </div>
