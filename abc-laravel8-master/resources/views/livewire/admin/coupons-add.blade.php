              ...
              <div class="card" style="padding: 5px 0;font-size:large " >
                  ...
                  <form wire:submit.prevent='addCoupon' >
                    ...
                    <div class="form-group">
                      ...
                      <input style="height: 40px" type="text" value="" class="form-control" name="coupons" id="coupon"  placeholder="coupon..." wire:model='code'>
                      @error('code')
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group" >
                        ...
                        <div class="wire" wire:ignore>
                            <input style="height: 40px" type="text" class="form-control" id="expiry_date"
                            placeholder="expiry_date..." wire:model='expiry_date'>
